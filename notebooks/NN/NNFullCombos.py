...
history = regr.fit(M[:], Y[:], epochs=3, batch_size=1000,  validation_data=(VAL_x,VAL_y))
...
Y = NN_gen_training_data.Y
M = NN_gen_training_data.M
...
print('comparison')
print(temp_y_interp[-10:],'predictions')
print(temp_y[-10:],'real values')
